// ObliqPlugIn.h : main header file for the Obliq plug-in.
//

#pragma once

// CObliqPlugIn
// See ObliqPlugIn.cpp for the implementation of this class
//

class CObliqPlugIn : public CRhinoUtilityPlugIn
{
public:
  ...
  // CObliqPlugIn destructor. The destructor is called to destroy
  // "thePlugIn" when the plug-in is unloaded. Immediately before the
  // DLL is unloaded, CObliqPlugIn::OnUnloadPlugin() is called. Do
  // not do too much here. Be sure to clean up any memory you have allocated
  // with onmalloc(), onrealloc(), oncalloc(), or onstrdup().
  ~CObliqPlugIn() = default;
